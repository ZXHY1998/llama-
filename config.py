...
def parse_arguments():
    ...
    parser.add_argument('--data_path', type=str, default='data/FinCorpus_tokenized', help="数据所在位置")
    parser.add_argument("--model_name_or_path", default='Llama-2-7b-hf',type=str,  help="模型文件位置")
    parser.add_argument('--save_name', type=str, default='test', help='模型保位置')

    # optimizer/lr_scheduler
    parser.add_argument("--learning_rate", type=float, default=5e-5, help="learning rate")
    parser.add_argument("--weight_decay", type=float, default=0.01, help="Weight decay")
    parser.add_argument("--num_warmup_steps", type=int, default=0, help="1r scheduler的warmup步数")
    ...
    parser.add_argument("--gradient_checkpointing", action='store_true',
                        help='是否开启梯度检查点，默认不开启。开启可节省GPU内存占用')
    ...
    parser.add_argument("--ds_steps_per_print", type=int, default=100, help="每个多少个step输出一次deepspeed日志")
