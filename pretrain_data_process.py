...
@dataclass
class DataArgs:
    model_name_or_path: str = field(default='Llama-2-7b-hf')  # tokenizer### *
    data_path: str = field(default='data')  # 待预处理的数据所在目录
    save_dir: str = field(default='data/FinCorpus_tokenized')  # 预处理后的数据的存放目录
    max_length: Optional[int] = field(default=4096)  # 每个样本的最大长度
...
if __name__ == '__main__':
    ...
    tokenizer.add_eostoken = True  # 增加<eos>的token标记
